...
public class EJERCICIO_B extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("SUCESIÓN: 3 - 6 + 9 - 12 + 15 - ....");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(78, 19, -1, 42));
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(18, 68, -1, -1));

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/PASTEL3 (1) (1).png"))); // NOI18N
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 520, 360));
    ...
    private void btnCalcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCalcularActionPerformed
        ...
        atArea.append("Para la sucesión B la suma de "+n+" terminos es: "+SumaB(n)+"\n");
        txtCantidad.setText("");
    ...
    public static long SumaB(int x)
    {
        if(x==0){
            return 0;
        }else{
            if(x%2==0)
                return -(x*3)+SumaB(x-1);
            else
                return (x*3)+SumaB(x-1);
        }
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EJERCICIO_B().setVisible(true);
            }
        });
    }
